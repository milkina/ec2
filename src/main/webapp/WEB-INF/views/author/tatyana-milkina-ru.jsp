...
<t:wrapper2>
  <jsp:attribute name="header">
    ...
    <meta property="og:title" content="Татьяна Милькина — Java-разработчик и автор | ExamClouds">
        ...
        <meta property="profile:last_name" content="Милькина">
        ...
        <meta property="og:url" content="https://www.examclouds.com/ru/tatyana-milkina">
  ...
  <main class="quiz-bg">
      <div class="container quiz-wrap">
        ...
        <nav class="quiz-crumbs" aria-label="Breadcrumb">
          ...
          <span class="sep">/</span>
          <span class="current">Об авторе</span>
           <script type="application/ld+json">{
                  ...
                  "itemListElement": [
                      ...
                      },
                      {
                          ...
                          "position": 2,
                          "name": "Об авторе",
                          "item": "https://www.examclouds.com/ru/tatyana-milkina"
                      }
                  ]
              }</script>
        </nav>
        ...
        <section class="quiz-card author-hero">
          <div class="author-photo-wrap">
            <div class="author-photo" aria-hidden="true">
              <img src="https://img.examclouds.com/general/tatyana-milkina.png" class="author-img" alt="Татьяна Милькина — Java-разработчик" />
            </div>
           <span class="author-badge">
              <span class="star" aria-hidden="true">★</span> Рейтинг 4.8
            </span>
          </div>

          <div class="author-intro">
            <p class="results-eyebrow">Автор курса</p>
            <h1 class="results-title">Татьяна Милькина</h1>
            <p class="author-role">Senior Java Developer · Преподаватель · 10 лет в корпоративной разработке на Java</p>
            <p class="author-lead">
              Татьяна пишет на Java более десяти лет — разрабатывает серверную часть приложений,
              менторит инженеров и помогает студентам получить первую работу разработчика. Она создала ExamClouds,
              чтобы сделать обучение Java структурированным, бесплатным и действительно интересным.
            </p>
        ...
        <section class="author-stats">
          <div class="author-stat">
            ...
            <div class="author-stat-label">Лет пишет на Java</div>
          </div>
          <div class="author-stat">
            <div class="author-stat-val">200+</div>
            <div class="author-stat-label">Опубликованных уроков</div>
          </div>
          <div class="author-stat">
            <div class="author-stat-val">20k+</div>
            <div class="author-stat-label">Студентов</div>
          </div>
          <div class="author-stat">
            <div class="author-stat-val">4.8★</div>
            <div class="author-stat-label">Средний рейтинг курса</div>
          </div>
        </section>
        ...
        <section class="quiz-card author-section">
          <h2 class="author-h2">Немного подробнее о Татьяне</h2>
          <ul class="author-bullets">
            ...
            <li>
              ...
              <p>Более 10 лет разрабатывает серверную часть приложений на Java, Spring и Hibernate.</p>
            </li>
            <li>
              <span class="ab-ic" aria-hidden="true">
              ...
              <p>Международные проекты в сферах healthcare, HR и телекоммуникаций.</p>
            </li>
            <li>
              <span class="ab-ic" aria-hidden="true">
              ...
              <p>Структурированные учебные материалы, тесты и практические примеры на ExamClouds.</p>
            </li>
          </ul>

          <hr class="author-divider">

          <h3 class="author-h3">Опыт</h3>
          <ul class="author-exp">
            <li>
            ...
            <li>
              ...
              5+ лет преподавания Java Core и ООП
            </li>
          </ul>

          <hr class="author-divider">

          <h3 class="author-h3">Темы курсов</h3>
