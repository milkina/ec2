                       ...
                       <!-- ===== RIGHT: progress & resources ===== -->
                          ...
                          <c:if test="${isVideo || isQuestions || isTests}">
                                 ...
                                 <ul class="lesson-side-list">
                                     ...
                                     <c:if test="${isTests}">
                                             <li><a href="${pageContext.request.contextPath}/${pathLanguage}start-test/${param.TEST_PATH}/${param.CATEGORY_PATH}" id="startTest"><span class="ic">📝</span><spring:message code="tests"/></a></li>
                                     </c:if>
                                     <c:if test="${isVideo}">
