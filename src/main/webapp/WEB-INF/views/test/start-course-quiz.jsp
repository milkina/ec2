...
<div id="collapse_q_${test.pathName}" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_q_${test.pathName}">
  <form action="${pageContext.request.contextPath}/quiz/${test.pathName}" method="post" class="test-form" aria-label="Start quiz form">
    ...
    <div class="test-form-grid">
      <div class="test-field test-field--wide">
        ...
        <select name="CATEGORY_PATH" id="CATEGORY_PATH_quiz_${test.pathName}" multiple="multiple" class="2col active" aria-required="true" aria-label="<spring:message code='category.label'/>" aria-describedby="CATEGORY_PATH_quiz_${test.pathName}_error" aria-invalid="false">
