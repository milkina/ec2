                ...
                <div class="course-ux-grid" style="margin-top:1.5rem;">
                    ...
                    <aside class="course-ux-side">
                        <div class="panel">
                            ...
                            <ul class="topic-list">
                              <c:forEach var="category" items="${VIDEO_CATEGORIES}">
                                <li><a href="${pageContext.request.contextPath}/java/java-core/${category.pathName}"><span class="t-name">${category.roadMapName!=null && not empty category.roadMapName?category.roadMapName:category.name}</span><span class="t-count">${category.subCategories.size()}</span></a></li>
                               </c:forEach>
                            </ul>
                        </div>
