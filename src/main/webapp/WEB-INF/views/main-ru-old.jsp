...
<cache:cacheTag/>
    ...
    <div class="container about-items">
             ...
             <section>
              ...
              <div class="row learn-java index-items-text">
               <div class="row">
                 <div class="col-md-4">
                   ...
                   <p><a href="#star-course">Теоретические материалы</a>, объясняющие основы и продвинутые темы Java.</p>
                 </div>
                 <div class="col-md-4">
                  <div class="icon-container">
              ...
              <p class="index-items-text">Для тех, кто стремится получить сертификат, рекомендуем обратить внимание на наш <a href="https://www.udemy.com/course/java-bup/" rel="nofollow sponsored noopener" target="_blank">курс на Udemy</a>.
