      ...
      <section class="section">
        <div class="container">
            ...
            <div class="card">
                ...
                <p>Настоящая политика обработки персональных данных определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые <strong>ExamClouds</strong> (далее – Оператор).</p>
                <p>1.1. Оператор ставит своей важнейшей целью и условием осуществления своей деятельности соблюдение прав и свобод человека и гражданина при обработке его персональных данных, в том числе защиты прав на неприкосновенность частной жизни, личную и семейную тайну.</p>
                <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <span data-scroll-to="#prefixURL" class="link mark">https://www.examclouds.com</span>.</p>
            </div>
        </div>
        <div class="container">
            <div class="card">
                ...
                <p>2.3. Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <span data-scroll-to="#prefixURL" class="link mark">https://www.examclouds.com</span>.</p>
                ...
                <p>2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта <span data-scroll-to="#prefixURL" class="link mark">https://www.examclouds.com</span>.</p>
                <p>2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, - персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее - персональные данные, разрешенные для распространения).</p>
                <p>2.10. Пользователь – любой посетитель веб-сайта <span data-scroll-to="#prefixURL" class="link mark">https://www.examclouds.com</span>.</p>
        ...
        <div class="container">
            <div class="card">
                ...
                <p>5.1. <mark>Адрес электронной почты; имя пользователя (логин) при регистрации;</mark></p>
                <p>5.2. Также на сайте автоматически собираются обезличенные данные о посетителях (в том числе IP-адрес, файлы «cookie», данные о браузере и устройстве, страницы и действия на сайте) с помощью сервисов интернет-статистики и рекламы (Google Analytics, Google AdSense). Подробнее — в разделе 14.</p> <p>5.3. Вышеперечисленные данные далее по тексту Политики объединены общим понятием Персональные данные.</p>
                ...
                <p>5.5. Согласие Пользователя на обработку персональных данных, разрешенных для распространения, оформляется отдельно от других согласий на обработку его персональных данных.</p>
        ...
        <div class="container">
            <div class="card">
                ...
                <p>– <mark>предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте https://www.examclouds.com;</mark></p>
        ...
        <div class="container">
            <div class="card">
                ...
                <p>8.1. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте <span data-scroll-to="#prefixURL" class="link mark">https://www.examclouds.com</span> или направленные Оператору посредством электронной почты. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.</p>
                ...
                <p>8.3. Субъект персональных данных самостоятельно принимает решение о предоставлении его персональных данных и дает согласие свободно, своей волей и в своем интересе.</p>
            </div>
        </div>
        <div class="container">
            <div class="card">
                ...
                <p>9.4. Осуществляется обработка персональных данных, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных либо по его просьбе (далее – общедоступные персональные данные).</p>
            </div>
        </div>
        <div class="container">
            <div class="card">
                ...
                <p>10.6. Оператор при обработке персональных данных обеспечивает конфиденциальность персональных данных.</p>
                <p>10.7. Оператор осуществляет хранение персональных данных в форме, позволяющей определить субъекта персональных данных, не дольше, чем этого требуют цели обработки персональных данных, если срок хранения персональных данных не установлен федеральным законом, договором, стороной которого, выгодоприобретателем или поручителем по которому является субъект персональных данных.</p>
                <p>10.8. Условием прекращения обработки персональных данных может являться достижение целей обработки персональных данных, истечение срока действия согласия субъекта персональных данных или отзыв согласия субъектом персональных данных, а также выявление неправомерной обработки персональных данных.</p>
            </div>
        </div>
        <div class="container">
            <div class="card">
        ...
        <h2>14. Файлы cookie и сторонние сервисы</h2>

        <p>14.1. Сайт использует файлы cookie — небольшие текстовые файлы, которые сохраняются в браузере Пользователя. Часть cookie необходима для работы сайта (например, сохранение сессии и выбранного языка), другие используются для аналитики и показа рекламы.</p>

        <p>14.2. При первом посещении сайта Пользователю показывается баннер согласия на использование cookie. Аналитические и рекламные cookie устанавливаются только после получения согласия Пользователя. Пользователь может изменить или отозвать своё согласие в любой момент через настройки cookie на сайте или через настройки своего браузера.</p>

        <p>14.3. Для работы сайта, анализа посещаемости и показа рекламы Оператор использует следующие сторонние сервисы:</p>
        <ul>
          <li><strong>Google Analytics</strong> — сбор обезличенной статистики о посещениях (страницы, источники трафика, устройства). Обработка данных регулируется <a href="https://policies.google.com/privacy" rel="nofollow noopener" target="_blank">Политикой конфиденциальности Google</a>.</li>
          <li><strong>Google AdSense</strong> — показ рекламных объявлений. Google и его партнёры могут использовать cookie для показа объявлений на основе предыдущих посещений Пользователем этого и других сайтов. Настроить показ персонализированной рекламы можно на странице <a href="https://myadcenter.google.com" rel="nofollow noopener" target="_blank">Настройки рекламы Google</a>.</li>
        </ul>

        <p>14.4. Оператор не контролирует cookie, устанавливаемые сторонними сервисами, и не несёт ответственности за их использование. Условия обработки данных этими сервисами определяются их собственными политиками конфиденциальности.</p>

        <h2>15. Права Пользователей из Европейского союза (GDPR)</h2>
        <p>15.1. Если Пользователь находится на территории Европейского союза, к обработке его персональных данных применяется Общий регламент по защите данных (GDPR).</p>
        <p>15.2. В соответствии с GDPR Пользователь имеет право: получить доступ к своим персональным данным; потребовать их исправления или удаления; ограничить или возразить против их обработки; получить свои данные в структурированном формате (право на переносимость); отозвать ранее данное согласие в любой момент.</p>
        <p>15.3. Правовыми основаниями обработки являются согласие Пользователя (например, на использование аналитических и рекламных cookie), а также законные интересы Оператора в обеспечении работы и улучшении сайта.</p>
        <p>15.4. Для реализации любого из указанных прав Пользователь может обратиться к Оператору по адресу электронной почты, указанному в разделе «Заключительные положения». Пользователь также вправе подать жалобу в надзорный орган по защите данных своей страны.</p>
        <p>15.5. Оператором (контролёром данных) в значении GDPR является ExamClouds. По любым вопросам, связанным с обработкой персональных данных, Пользователь может связаться по адресу электронной почты, указанному в разделе 17.</p>
        <h2>16. Международная передача данных</h2>
        <p>16.1. При использовании сервисов Google (Analytics, AdSense) персональные данные Пользователя могут передаваться и обрабатываться на серверах, расположенных за пределами страны проживания Пользователя, в том числе в США. Такая передача осуществляется в соответствии с политиками конфиденциальности соответствующих сервисов и применимыми механизмами защиты данных. Дата последнего обновления: 2026-07-02</p>
        </div>
               </div>
        <div class="container">
            <div class="card">
                <h2>17. Заключительные положения</h2>
                <p>17.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <span data-scroll-to="#privacyEmail" class="link mark">tatyana.milkina@gmail.com</span>.</p>
                <p>17.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика действует бессрочно до замены ее новой версией.</p>
                <p>17.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <span data-scroll-to="#prefixURL" class="link mark">https://www.examclouds.com</span>. Last updated: 2026-07-02</p>
            </div>
        </div>
        </section>
     </main>
