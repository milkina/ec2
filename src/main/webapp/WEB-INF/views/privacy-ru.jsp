      ...
      <section class="section">
        ...
        <div class="container">
            <div class="card">
                ...
                <p>5.1. <mark>Адрес электронной почты;</mark></p>
                <p>5.2. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов «cookie») с помощью сервисов интернет-статистики (Гугл Аналитика и других).</p>
        ...
        <div class="container">
            <div class="card">
                ...
                <p>17.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <span id="genURLLink" data-scroll-to="#prefixURLLink" class="link mark">https://www.examclouds.com/ru/privacy/</span>.</p>
            </div>
        </div>
        </section>
     </main>
