...
<t:wrapper2>
    <jsp:attribute name="header">
        ...
        <meta name="description" content="<spring:message code="quiz.meta.description" arguments="${CATEGORY_ATTRIBUTE.name},${TESTS[param.TEST_PATH].name},${CATEGORY_ATTRIBUTE.questionsCount}"/>">
        ...
        <!-- LearningResource Schema -->
                <script type="application/ld+json">{
                  ...
                  "description": "<spring:message code="quiz.meta.description" arguments="${CATEGORY_ATTRIBUTE.name},${TESTS[param.TEST_PATH].name},${CATEGORY_ATTRIBUTE.questionsCount}"/>",
