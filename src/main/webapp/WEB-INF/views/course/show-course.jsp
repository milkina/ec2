    ...
    <main class="course-bg" style="padding:0 0 3rem;">
        ...
        <c:forEach var="category" items="${TESTS[param.TEST_PATH].categories}">
            <c:if test="${empty firstCategoryPath && category.value.hidden==false && category.value.parentCategory==null}">
                <c:set var="firstCategoryPath" value="${category.value.pathName}"/>
            </c:if>
        </c:forEach>
     <!-- ===== Blue hero ===== -->
            ...
            <div class="course-ux-grid">
                ...
                <section id="modules" class="panel">
                  ...
                  <div class="modules-grid">
                    ...
                    <article class="module-card">
                      ...
                      <a class="module-more" href="${pageContext.request.contextPath}/${pageLanguage=='ru'?'ru/':''}java/${param.TEST_PATH}/${category.value.pathName}"><spring:message code="show.more"/> ›</a>
                    </article>
                     </c:if>
                                    </c:forEach>
                  </div>
              ...
              <aside class="course-ux-side">
                <div class="panel">
                  ...
                  <ul class="res-list">
                    <li><a href="https://www.youtube.com/c/tatyanamilkina" target="_blank" rel="noopener nofollow"><span class="ic" style="background:oklch(0.6 0.22 27)">▶</span><div><b><spring:message code="youtube.channel"/></b><span><spring:message code="youtube.channel.subtitle"/></span></div></a></li>
                    <li><a href="https://www.udemy.com/course/java-bup/" target="_blank" rel="nofollow sponsored noopener"><span class="ic" style="background:oklch(0.55 0.18 285)">🎓</span><div><b><spring:message code="udemy.course"/></b><span><spring:message code="udemy.course.subtitle"/></span></div></a></li>
                    <li><a href="https://www.patreon.com/bePatron?u=71601793" target="_blank" rel="noopener nofollow sponsored"><span class="ic" style="background:oklch(0.6 0.2 25)">♥</span><div><b><spring:message code="patreon.support"/></b><span><spring:message code="patreon.support.subtitle"/></span></div></a></li>
                    <li><a href="https://t.me/examclouds/" target="_blank" rel="nofollow noopener"><span class="ic" style="background:oklch(0.65 0.15 235)">✈</span><div><b><spring:message code="telegram.community"/></b><span><spring:message code="telegram.community.subtitle"/></span></div></a></li>
                  </ul>
                </div>
              </aside>
            </div>
