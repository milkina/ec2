...
<t:wrapper2>
 ...
 <jsp:attribute name="header">
    ...
    <meta name="description" content="<spring:message code='login.description'/>">
        ...
        <form class="auth-form" action="${pageContext.request.contextPath}${pageLanguage=='ru'?'/ru':''}/login" method="post" id="LoginForm">
          ...
          <div class="auth-field">
            ...
            <div class="auth-input-wrap">
              ...
              <input id="password" class="auth-input has-icon" type="password" placeholder="••••••••" autocomplete="current-password" name="password"/>
            </div>
          </div>

          <div class="auth-row">
            <label><input type="checkbox" checked2 name="Remember"> <spring:message code="remember.me"/></label>
            <span class="wrongMessage" id="wrongMessage">${wrongLoginMessage}</span>
          <!--  <a href="#">Forgot password?</a>-->
          </div>

          <button class="auth-submit" type="submit"><spring:message code="log.in"/></button>
        </form>
      </div>
