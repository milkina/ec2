          ...
          <div class="auth-out">
            <div class="user-menu">
              ...
              <div class="user-dropdown" data-user-panel hidden role="menu">
                ...
                <a href="${pageContext.request.contextPath}/${pageLanguage=='ru'?'ru/':''}show-user-profile" role="menuitem">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
    ...
    <div class="container links">
      ...
      <c:choose>
        ...
        <c:otherwise>
          ...
          <a class="m-item" href="${pageContext.request.contextPath}/${pageLanguage=='ru'?'ru/':''}show-user-profile">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
            <spring:message code="my.profile.label"/>
          </a>
